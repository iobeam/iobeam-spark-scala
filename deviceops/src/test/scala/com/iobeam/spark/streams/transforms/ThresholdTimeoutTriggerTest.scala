...
class ThresholdTimeoutTriggerTest extends FlatSpec with Matchers with MockitoSugar {
    ...
    "Threshold" should "trigger when value has been above threshold for longer than timeout" in {
        ...
        val threshold = new ThresholdTimeoutTrigger(0.7, 0.5, Milliseconds(100), triggerEvent,
            releaseEvent).getNewTransform
    ...
    "Threshold" should "trigger when value has been above threshold for longer than timeout and " +
        "start above threshold" in {

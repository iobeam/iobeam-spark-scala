...
class ThresholdTriggerTest extends FlatSpec with Matchers with MockitoSugar {
    ...
    "Threshold" should "trigger above threshold and below release" in {
        ...
        val threshold = new ThresholdTrigger(0.7, triggerEvent, 0.5, releaseEvent).getNewTransform
    ...
    "Threshold" should "trigger only above threshold" in {
        ...
        val threshold = new ThresholdTrigger(0.7, triggerEvent, 0.5).getNewTransform
    ...
    "Threshold" should "trigger below threshold and trigger above release level" in {
        ...
        val threshold = new ThresholdTrigger(0.5, triggerEvent, 0.7, releaseEvent).getNewTransform
    ...
    "Threshold" should "trigger below threshold" in {
        ...
        val threshold = new ThresholdTrigger(0.5, triggerEvent, 0.7).getNewTransform
    ...
    "Threshold" should "trigger above threshold and release below same level" in {
        ...
        val threshold = new ThresholdTrigger(0.5, triggerEvent, 0.5, releaseEvent).getNewTransform
